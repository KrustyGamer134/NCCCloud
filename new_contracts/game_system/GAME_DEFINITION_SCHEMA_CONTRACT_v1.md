...
- host-owned control metadata, local settings, and shared masters must resolve beneath the host control root defined by the host storage layout contract, not inside cloud-owned persistence
